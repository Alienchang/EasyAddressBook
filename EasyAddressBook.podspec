#
#  Be sure to run `pod spec lint EasyAddressBook.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.1"
  s.summary      = "A short description of EasyAddressBook."
  ...
  # Or just: s.author    = "Alienchang"
  # s.authors            = { "Alienchang" => "1217493217@qq.com" }
  # s.social_media_url   = "http://twitter.com/Alienchang"
